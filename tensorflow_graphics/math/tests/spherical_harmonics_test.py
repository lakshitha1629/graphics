...
class SphericalHarmonicsTest(test_case.TestCase):
  ...
  @parameterized.parameters(
      ...
      ("The last dimension of 'theta' and 'phi' must be 1.", (3,), (3,), (2, 2),
       (2, 2)),
  ...
  @parameterized.parameters(
      ...
      ("'zonal_coeffs' must have 1 dimension.", (4, 1), (5, 1), (5, 1)),
      ("The last dimension of 'theta' and 'phi' must be 1.", (4,), (5, 2),
       (5, 2)),
  )
