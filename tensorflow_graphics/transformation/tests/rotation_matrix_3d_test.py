...
class RotationMatrix3dTest(test_case.TestCase):
  ...
  @parameterized.parameters(
      ("'rotation_matrix_3d' must have 3x3 dimensions.", (3,)),
      ("'rotation_matrix_3d' must have 3x3 dimensions.", (2, 3)),
      ("'rotation_matrix_3d' must have 3x3 dimensions.", (3, 2)),
  )
  ...
  def test_from_axis_angle_normalized_preset(self):
    ...
    self.assertAllEqual(
        rotation_matrix_3d.is_normalized(matrix_axis_angle),
  ...
  def test_from_euler_normalized_preset(self):
    ...
    self.assertAllEqual(
        rotation_matrix_3d.is_normalized(matrix),
        np.ones(euler_angles.shape[0:-1] + (1,)))
  ...
  def test_from_euler_random(self):
    ...
    # Build the expected transformation piece by piece.
  ...
  def test_from_quaternion_normalized_preset(self):
    ...
    self.assertAllEqual(
        rotation_matrix_3d.is_normalized(matrix_quat),
        np.ones(euler_angles.shape[0:-1] + (1,)))
  ...
  def test_from_quaternion_normalized_random(self):
    ...
    self.assertAllEqual(
        rotation_matrix_3d.is_normalized(random_matrix),
        np.ones(tensor_shape + (1,)))
  ...
  def test_inverse_normalized_random(self):
    ...
    self.assertAllEqual(
        rotation_matrix_3d.is_normalized(predicted_invert_random_matrix),
  ...
  def test_is_normalized_exception_not_raised(self, *shapes):
    """Tests that the shape exceptions are not raised."""
    self.assert_exception_is_not_raised(rotation_matrix_3d.is_normalized,
                                        shapes)

  @parameterized.parameters(
      ("'rotation_matrix_3d' must have 3x3 dimensions.", (3,)),
      ("'rotation_matrix_3d' must have 3x3 dimensions.", (3, None)),
      ("'rotation_matrix_3d' must have 3x3 dimensions.", (None, 3)),
  )
  def test_is_normalized_exception_raised(self, error_msg, *shape):
    """Tests that the shape exceptions are raised."""
    self.assert_exception_is_raised(rotation_matrix_3d.is_normalized, error_msg,
                                    shape)
  ...
  def test_is_normalized_random(self):
    ...
    pred_normalized = rotation_matrix_3d.is_normalized(rotation_matrix)
    self.assertAllEqual(pred_normalized,
                        np.ones(shape=tensor_tile + (1,), dtype=bool))
    # Orthogonal matrix with determinant equal to 1, but not orthonormal.
    test_matrix = np.array([[2., 0., 0.], [0., 0.5, 0], [0., 0., 1.]])
    pred_normalized = rotation_matrix_3d.is_normalized(test_matrix)
    self.assertAllEqual(pred_normalized, np.zeros(shape=(1,), dtype=bool))
    # Orthonormal matrix, but with determinant equal to -1.
  ...
  @parameterized.parameters(
      ("'point' must have 3 dimensions.", (None,), (3, 3)),
      ("'matrix' must have 3x3 dimensions.", (3,), (3,)),
      ("'matrix' must have 3x3 dimensions.", (3,), (3, None)),
      ("'matrix' must have 3x3 dimensions.", (3,), (None, 3)),
  )
